...
def execute_engine(file_path):
    if file_path:
        ...
        result = subprocess.run(["/home/retiantonio/CyberSecurity/antivirus-software-development/antivirusengine", file_path], stdout=subprocess.PIPE)
...
image = PhotoImage(file="/home/retiantonio/CyberSecurity/antivirus-software-development/shield-halved-solid.png")
